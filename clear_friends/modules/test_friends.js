...
module.exports = (() => {
    ...
    function assertionFriend() {
        while (true) {
            ...
            if (node == null && node_util.backtrackClickNode(descMatches(texts["close_text"]).findOnce())) {
                ...
                normal_friends[last_we_chat_id] = { we_chat_id: last_we_chat_id, friend_remark: last_friend_remark, selected: false, deleted: false };
                step = 8;
                break;
    ...
    function stopScript() {
        ...
        files.write("./data/ignore_friends.json", JSON.stringify(ignore_friends));
    ...
    function main() {
        ...
        if (launch(config["we_chat_package_name"])) {
            ...
            last_we_chat_id = "", last_friend_remark = "", last_index = -1, step = 0, run = true, ignore_friends = {};
