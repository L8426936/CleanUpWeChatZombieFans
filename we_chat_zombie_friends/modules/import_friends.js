(() => {
    ...
    function synchronizeFriends() {
        ...
        for (let i = 0; i < friend_remark_nodes.size(); i++) {
            ...
            if (!db_util.hasFriendWhitelist(friend_remark) && !db_util.addFriendWhitelist({friend_remark: friend_remark, ignored: false})) {
                ui.run(() => {
        ...
        if (launch(config["we_chat_package_name"])) {
            ...
            window = floaty.window(
                <vertical padding="8" bg="#000000">
                    ...
                    <scroll h="100" id="import_friends_fail_text_scroll"><text textColor="red" layout_gravity="top" id="import_friends_fail_text"/></scroll>
